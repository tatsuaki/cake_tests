...
<?php
	...
	array('class' =>'delete', 'data-comment-id' => $comment['id'])); ?>
</li>
<?php endforeach; ?>
</ul>
...
echo $this->Form->input('Comment.post_id',
	array('type'=>'hidden', 'value' =>$post['Post']['id']));
echo $this->Form->end('post coment');
?>
...
$(function() {
	$('a.delete').click(function(e) {
		if (confirm('まじでん？')) {
			$.post('/cake5/comments/delete/' +$(this).data('comment-id'),{},function(res) {
